                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                ...
                                <form action="marca_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <div class="box-body">
                                        <?php 
                                        $marca = consultas::get_datos("select * from marca where mar_cod =".$_GET['vmar_cod']);
                                        //var_dump($marca);
                                        ?>
                                        <input type="hidden" name="accion" value="3"/>
                                        <input type="hidden" name="vmar_cod" value="<?php echo $marca[0]['mar_cod'];?>"/>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-2"> Descripción</label>
                                                <div class="col-lg-8 col-md-8">
                                                    <input type="text" name="vmar_descri" class="form-control" required="" minlength="5" disabled=""
                                                           value="<?php echo $marca[0]['mar_descri'];?>">
                                            </div>
                                        </div>
                                    </div>
