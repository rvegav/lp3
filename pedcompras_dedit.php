...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-edit"></i> Editar Detalle de Pedido</h4>
</div>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                <input type="number" name="vped_cant" class="form-control" min="1" value="<?php echo $detalle[0]['ped_cant'] ?>" required="" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-lg-2 col-sm-3 col-md-2 col-xs-2">Precio:</label>
            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                <input type="number" name="vped_precio" class="form-control" min="1" required="" value="<?php echo $detalle[0]['ped_precio'] ?>" />
            </div>
        </div>
    </div>
