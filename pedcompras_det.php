                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                             
                                            <?php $pedidosdet = consultas::get_datos("select * from v_detalle_pedcompra where ped_cod =".$pedidos[0]['ped_cod']);
                                            if (!empty($pedidosdet)) { ?>
                                                <div class="box-header">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                                <form action="pedcompras_dcontrol.php" method="get" accept-charset="utf-8" class="form-horizontal">
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-2 col-sm-3 col-md-2 col-xs-2">Precio Compra Ref:</label>
                                                            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
...
<script>
      function edit(id,art,dep){        
        $.ajax({
            type    : "GET",
            url     : "/lp3/pedcompras_dedit.php/?vped_cod="+id+"&vart_cod="+art+"&vdep_cod="+dep,
            cache   : false,
            beforeSend:function(){
        ...
        success : function(json) {
           ...
           if(js.articulos!=null){
            ...
            for (var i = 0; i < js.articulos.length; i++) {
                html1 += "<option value='"+js.articulos[i].art_cod+"_"+js.articulos[i].art_precioc+"'>"+js.articulos[i].art_descri+" - "+js.articulos[i].mar_descri+"</option>"; 
            }
           }else{
