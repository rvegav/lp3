                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <a href="compras_index.php" class="btn btn-primary pull-right btn-sm"><i class="fa fa-arrow-left"></i></a>
                                </div>
                                <form action="compras_control.php" method="get" accept-charset="utf-8" class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-lg-2 col-md-2 col-xs-2"> Fecha:</label>
                                                <div class="col-lg-4 col-md-4 col-xs-4">
                                                    <input type="text" name="vcom_fecha" class="form-control" value="<?php echo $fecha[0]['fecha']?>" disabled="">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-sm-2 col-md-2 col-xs-2"> Proveedor:</label>
                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-10">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2" name="vprv_cod" required="" onchange="pedidos()" id="proveedor">
                                        ...
                                        <div class="form-group tipo" style="display: none">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-xs-12">
                                                <input type="number" name="vcom_plazo" class="form-control" min="0" max="90" value="0" readonly="" id="intervalo">
                                            </div>                                                                                        
                                        </div>                                        
                                        <div class="form-group">
