                            ...
                            <div class="box box-primary">
                                ...
                                <form action="factura_compra_control.php" method="get" accept-charset="utf-8" class="form-horizontal" id="frm_fact_compra">
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-lg-6 col-md-6">
                                                <label> Proveedor:</label>
                                                    <div >
                                                        <?php $proveedores = consultas::get_datos("select * from proveedor");?>
                                        ...
                                        <select class="form-control select2" name="vprv_cod" required="" id="tipo_detalle" onchange="mostrar();">
                                            <option value="1">Seleccionar por</option>
                                            <option value="1">Por Orden de compra</option>
                                            <option value="2">Por Articulos</option>
                                        </select>                
