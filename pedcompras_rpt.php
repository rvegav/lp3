                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    ...
                                                                    <a href="pedcompras_rpt.php?opcion=4" class="list-group-item"> Por Sucursal</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>    
                                                    <div class="col-md-8">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <?php 
                                                             ...
                                                             break;
                                                                    case 4: 
                                                                        $sucursales = consultas::get_datos("select * from sucursal where id_sucursal in(select id_sucursal from pedido_cabcompra)");
                                                                        ?>
                                                                <div class="form-group">
