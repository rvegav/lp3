...
<div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
    <?php $pedidos = consultas::get_datos("select * from v_pedido_cabcompra where prv_cod=" . $_REQUEST['vprv_cod'] . " and id_sucursal=" . $_SESSION['id_sucursal'] . " and estado ='PENDIENTE'"); ?>
