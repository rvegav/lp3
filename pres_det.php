                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php } ?>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                             
                                            <?php $presupuestos = consultas::get_datos("select * from detalle_presupuesto dp join articulo a on a.art_cod = dp.depr_art_cod");
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-condensed table-striped table-hover table-bordered">
                                                        ...
                                                        <?php foreach ($presupuestos as $presupuesto) { ?>
                                                                <tr>
                                                                   <td><?php echo $presupuesto['com_cod']; ?></td>
                                                                    <td><?php echo $presupuesto['com_fecha']; ?></td>
                                                                    <td><?php echo $presupuesto['proveedor']; ?></td>
                                                                    <td><?php echo $presupuesto['tipo_compra']; ?></td>
                                                                    <td><?php echo number_format($presupuesto['com_total'], 0, ",", "."); ?></td>
                                                                    <td><?php echo $presupuesto['com_estado']; ?></td>
                                                                </tr>
                                                        <?php } ?>                                                            
                                                        </tbody>
                                                    </table>
