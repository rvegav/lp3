...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-plus"></i> Agregar Detalle de Compras</h4>
</div>
<form action="compras_dcontrol.php" method="post" accept-charset="utf-8" class="form-horizontal">
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                <input type="number" name="vcom_precio" class="form-control" min="1" required="" value="<?php echo $detalle[0]['ped_precio'] ?>" />
            </div>
        </div>
    </div>
