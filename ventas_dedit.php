...
#session_start();
$detalle = consultas::get_datos("select * from v_detalle_ventas where ven_cod =" . $_REQUEST['vven_cod'] . " and dep_cod=" . $_REQUEST['vdep_cod'] . " and art_cod =" . $_REQUEST['vart_cod'])
?>
...
<form action="ventas_dcontrol.php" method="post" accept-charset="utf-8" class="form-horizontal">
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                <input type="hidden" name="vart_cod" class="form-control" value="<?php echo $detalle[0]['art_cod'] . "_" . $detalle[0]['ven_precio'] ?>" />
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                <input type="number" name="vven_cant" class="form-control" min="1" value="<?php echo $detalle[0]['ven_cant'] ?>" required="" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-lg-2 col-sm-3 col-md-2 col-xs-2">Precio:</label>
            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                <input type="number" name="vven_precio" class="form-control" min="1" required="" value="<?php echo $detalle[0]['ven_precio'] ?>" />
            </div>
        </div>
    </div>
