                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                ...
                                <form action="deposito_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <div class="box-body">
                                        <?php 
                                        $deposito = consultas::get_datos("select * from deposito where dep_cod =".$_GET['vdep_cod']);
                                        //var_dump($marca);
                                        ?>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-2"> Descripción</label>
                                                <div class="col-lg-8 col-md-8">
                                                    <input type="text" name="dep_descri" class="form-control" required="" minlength="5" disabled=""
