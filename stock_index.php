                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <a href="stock_add.php" class="btn btn-primary btn-sm pull-right" role="button"><i class="fa fa-plus"></i></a>                                                                            
                                ...
                                <?php }else{echo 'aca';} ?>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php
                                            $articulos = consultas::get_datos("select * from v_stock where (art_descri||mar_descri) ilike '%".(isset($_REQUEST['buscar'])? $_REQUEST['buscar']:"")."%' order by art_cod");
                                            if (!empty($articulos)) {
                                                ?>
                                                    ...
                                                    <table class="table table-condensed table-striped table-hover table-bordered">
                                                        ...
                                                        <?php foreach ($articulos as $articulo) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $articulo['dep_descri']; ?></td>    
                                                                    <td><?php echo  $articulo['stoc_cant']; ?></td>    
                                                                    <td class="text-center">
                                                                        <a href="stock_edit.php?vart_cod=<?php echo $articulo['art_cod']?>&vdep_cod=<?php echo $articulo['dep_cod']; ?>" class="btn btn-warning btn-sm" role="button" 
                                                                           data-title="Editar" rel="tooltip" data-placement="top">
                                                                            <i class="fa fa-edit"></i>
                                                                        </a>

                                                                        <!--<a onclick="borrar(<?php echo "'".$articulo['art_cod']."','".$articulo['dep_cod']."','".$articulo['dep_descri']."'";?>)" data-toggle="modal" data-target="#borrar"
...
<script>
    function borrar(artCod,depCod,dep){
       // var dat = datos.split('_');
//        alert(dat[1])
        $("#si").attr('href','stock_control.php?vart_cod='+artCod+'&vdep_cod='+depCod+'&accion=3&vart_cantidad=0');
        $("#confirmacion").html('<span class="glyphicon glyphicon-warning-sign"></span> Desea borrar el articulo <i><strong>'+dep+'</strong></i>?');
    };    
